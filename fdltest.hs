...
interpret (("color":xs):yss)  start rules m depth len _   width = interpret yss start rules m depth len (interpretColor xs rgb) width where
  interpretColor ["Black"]       rgb = (RGB 0 0 0)
  interpretColor ["Red"]         rgb = (RGB 255 0 0)
  interpretColor ["Green"]       rgb = (RGB 0 255 0) 
  interpretColor ["Blue"]        rgb = (RGB 0 0 255) 
  interpretColor ["White"]       rgb = (RGB 255 255 255) 
  interpretColor ["Cyan"]        rgb = (RGB 0 255 255) 
  interpretColor ["Magenta"]     rgb = (RGB 255 0 255) 
  interpretColor ["Yellow"]      rgb = (RGB 255 255 0) 
  interpretColor ["Random"]      rgb = (RGB 48 213 200) 
  interpretColor [integer]       rgb = (RGB(read (xs !! 0)) (read (xs !! 1)) (read (xs !! 2)))
